...
export async function createContainerReq(id: string) {
  ...
  await DIContainer.sharedContainer.containerRequestRepository.create(_.clone(invitation))
}

export async function createProjectInvitation(id: string) {
  const projectInvitation: any = _.clone(
    projectInvitationsList.find((projectInvitation) => {
...
export async function createManuscript(id: string, userId?: string) {
  ...
  await DIContainer.sharedContainer.manuscriptRepository.create(_.clone(manuscript), userId)
}
