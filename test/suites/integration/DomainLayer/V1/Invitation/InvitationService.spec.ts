...
describe('InvitationService - updateInvitedUserID', () => {
  beforeEach(async () => {
  ...
  test('should patch user id every invitation with the specified the user email', async () => {
    const invitationService = DIContainer.sharedContainer.invitationService
    ...
    const invitations = await DIContainer.sharedContainer.invitationRepository.getAllByEmail(
      'valid-google@manuscriptsapp.com'
    )
