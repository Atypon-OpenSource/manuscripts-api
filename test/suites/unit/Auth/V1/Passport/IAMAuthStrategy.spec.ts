...
describe('IAMAuthStrategy', () => {
  ...
  test('verifyIAMToken valid token should not throw error', async () => {
    ...
    req = {
      query: {
        id_token:
          'eyJhbGciOiJub25lIn0..',
        state: '',
      },
      headers: {
