...
export enum InternalErrorCode {
  ...
  MissingSnapshotError = 'SNAPSHOT_NOT_FOUND',
  MissingDocumentError = 'DOC_NOT_FOUND',
  UpdateDocumentError = 'DOC_NOT_UPDATED',
  CreateDocumentError = 'DOC_NOT_CREATED',
  DeleteDocumentError = 'DOC_NOT_DELETED',
  CreateSnapshotError = 'SNAPSHOT_NOT_CREATED',
  DeleteSnapshotError = 'SNAPSHOT_NOT_DELETED',
  CreateDocumentHistoryError = 'DOC_HISTORY_NOT_CREATED',
  MissingDocumentHistoryError = 'DOC_HISTORY_NOT_FOUND',
